...
export default function About() {
  return (
    <section id="sobre" className="py-24 md:py-32 bg-warm overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20 md:gap-24 items-center">
          ...
          <div className="flex justify-center md:justify-end order-1 md:order-2">
            <div className="relative group">
              ...
              <div className="absolute -bottom-4 -right-2 md:-right-6 bg-ink/90 backdrop-blur-md text-white/90 px-4 py-2.5 rounded-full shadow-lg border border-white/10 flex items-center gap-2 group-hover:bg-accent transition-colors duration-500 z-10">
          ...
          <div className="order-2 md:order-1 mt-8 md:mt-0">
            <div className="inline-block px-4 py-1.5 bg-accent/10 rounded-full mb-10 md:mb-12 text-center md:text-left w-full md:w-auto">
              <span className="font-sans text-[10px] uppercase tracking-[0.3em] text-accent font-bold">
                A Jornada por trás da lente
              </span>
            </div>
            
            <h2 className="font-serif text-5xl md:text-6xl lg:text-7xl font-semibold text-ink leading-[1.1] mb-12">
              Bruno <span className="font-light italic text-accent">França</span>
            </h2>

            <div className="space-y-10 md:space-y-12 text-muted leading-relaxed max-w-xl">
              ...
              <blockquote className="border-l-4 border-accent/20 pl-10 py-3 my-16 md:my-20">
                <p className="font-serif italic text-ink/60 text-xl md:text-2xl leading-relaxed">
                  "Minha fotografia explora a fronteira entre o registro documental e a arte visual, transformando a geografia em emoção."
                </p>
              </blockquote>
            </div>

            <div className="mt-16 md:mt-20 flex items-center justify-center md:justify-start gap-6">
              <a
                href="https://instagram.com/obrunuaf"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 text-ink bg-white hover:bg-ink hover:text-white border border-ink/10 px-8 py-4 rounded-full transition-all duration-300 shadow-sm hover:shadow-md group"
              >
