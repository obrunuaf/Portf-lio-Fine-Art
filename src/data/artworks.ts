...
export const artworks: Artwork[] = [
  {
    ...
    description: "Na imensidão turquesa de São Bento, uma embarcação repousa em silêncio. A obra principal da coleção.",
  ...
  },
  {
    ...
    description: "Visto de cima, o recife deixa de ser pedra e vira mapa. Tons de ocre e dourado esculpidos por séculos de marés.",
    category: "Textura",
  ...
  },
  {
    ...
    description: "A textura complexa onde o recife encontra a areia, criando uma fronteira natural visível apenas do céu.",
    category: "Abstrato",
    orientation: "landscape",
    details: {
      drone: "DJI Air 3S",
  ...
  },
  {
    ...
    description: "O movimento de uma embarcação traçando seu curso ao longo da barreira de corais.",
    category: "Movimento",
    orientation: "landscape",
    details: {
      drone: "DJI Air 3S",
  ...
  },
  {
    ...
    description: "Uma vista panorâmica da costa, onde as águas calmas protegem a vida marinha.",
    category: "Paisagem",
    orientation: "landscape",
    details: {
      drone: "DJI Air 3S",
  ...
  },
  {
    ...
    description: "Pequenos barcos coloridos ancorados sobre a areia dourada, como pinceladas em uma tela.",
    category: "Cultura",
    orientation: "landscape",
    details: {
      drone: "DJI Air 3S",
  ...
  },
  {
    ...
    description: "Um banco de areia extenso que divide o mar em dois tons, criando uma passarela natural.",
    category: "Geometria",
    orientation: "landscape",
    details: {
      drone: "DJI Air 3S",
  ...
  },
  {
    ...
    description: "A maré baixa revela caminhos efêmeros onde barcos repousam à espera do oceano.",
    category: "Aéreo",
    orientation: "landscape",
    details: {
      drone: "DJI Air 3S",
...
export const getImageSrc = (filename: string): string =>
  encodeURI(`/Maragogi Secret/${filename}`)
